...
def step_write_readme(ep1_slug: str, ep2_slug: str) -> None:
    ...
    readme = f"""# equity-os End-to-End Demo — MSFT

This directory contains all artifacts from a complete equity research coverage
cycle for **Microsoft Corporation (MSFT)**, generated by the equity-os system
...
def main() -> None:
    print("\n" + "=" * 60)
    print("  equity-os End-to-End Demo — Microsoft (MSFT)")
    print("=" * 60)
